<template>
    ...
    <div class="flex w-full flex-1 flex-col justify-center">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <UForm :schema="schema" :state="state" class="space-y-6" @submit="signup">
                ...
                <UFormGroup label="Password" name="password">
                  ...
                  <div>
                    <button type="submit" class="flex w-full justify-center rounded-md bg-blue-400 px-4 py-2.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-blue-500">Sign up</button>
                  </div>
...
const signup = async () => {
    ...
    if (result) navigateTo('/', {external:true})
}

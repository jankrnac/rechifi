<template>
        ...
        <div>
            ...
            <div class="mx-auto max-w-3xl text-center lg:max-w-app">
                <div class="pb-10 mt-10 lg:mt-16 lg:pb-24">
                    <h1 class="text-3xl lg:text-6xl font-bold tracking-tigh">{{ t('dacs') }}</h1>
    ...
    const { data:headphones, refresh } = await useAsyncData('dacs', () => 
    ...
    <i18n lang="yaml">
        en:
         ...
         sort: 'Sort'
         slogan: All DACs from asian country manufacturers in one place
         name: 'By name'

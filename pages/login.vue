...
<div class="flex w-full flex-1 flex-col justify-center px-6 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    	<form class="space-y-6" action="#" method="POST" @submit.prevent="login">
			...
			<button type="button" @click="handleSignInWithGoogle" class="w-full border border-gray-300 dark:border-gray-600 hover:bg-gray-50 transition font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#4285F4]/55 mr-2 mb-2">

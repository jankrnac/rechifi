...
<footer class="border-t mt-32 dark:border-gray-700" aria-labelledby="footer-heading">
    <h2 id="footer-heading" class="sr-only">Footer</h2>
    <div class="mx-auto max-w-app pb-8 pt-20 sm:pt-24  lg:pt-32">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div class="mt-10 xl:mt-0">
			...
			<div class="flex mt-6 gap-x-2 text-sm font-bold text-gray-400">
				<div class="cursor-pointer hover:text-black dark:hover:text-white" :class="{'text-black':locale == 'cz'}" @click="locale = 'cz'">CZ</div>
				<div class="cursor-pointer hover:text-black dark:hover:text-white" :class="{'text-black':locale == 'en'}" @click="locale = 'en'">EN</div>
			</div>
          </div>
        </div>
	...
	<div class="border-t border-gray-900/10 dark:border-gray-700 mt-16">
		<div class="max-w-app mx-auto py-6 md:flex md:items-center md:justify-between text-gray-500">
			...
			<p class="mt-8 text-xs leading-5 md:order-1 md:mt-0">&copy; 2024 Chifi.cz</p>
		</div>
	</div>

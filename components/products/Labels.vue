<template>
      <div class="flex w-full max-w-app items-start justify-between mb-16 md:mb-32 flex-wrap">
        ...
        <div>
            <div class="text-sm mb-2 lg:text-right mt-6 lg:mt-0">Sound signature</div>
